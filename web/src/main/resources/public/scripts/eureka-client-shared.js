...
// Note:  This SHOULD be minified and concatenated on to external-js-min.js during the build.  (Also would need to
// remove the script tag for it in index.html and widget.html to not load it twice.)
