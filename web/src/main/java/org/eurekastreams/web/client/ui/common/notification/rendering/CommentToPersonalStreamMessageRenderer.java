 ...
 */
public class CommentToPersonalStreamMessageRenderer extends NotificationMessageRenderer
{
    /**
     * {@inheritDoc}
     */
    ...
    protected void render(final Panel parent, final ApplicationAlertNotification notification)
    {
        ...
        appendText(parent, " commented on a ");
        appendActivityLink(parent, notification);
        appendText(parent, " in your stream.");
    }
}
