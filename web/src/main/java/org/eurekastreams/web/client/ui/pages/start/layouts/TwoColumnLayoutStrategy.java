...
/**
 * Creates a 2 column layout with each being 50%.
 */
public class TwoColumnLayoutStrategy implements LayoutPanelStrategy
{
    /**
     * List of drop zones.
     */
     ...
     * Public constructor.
     */
    public TwoColumnLayoutStrategy()
    {
        dropZones.add(DropZonePanel.getHalfColumnDropZone(0));
        dropZones.add(DropZonePanel.getHalfColumnDropZone(1));
    }
