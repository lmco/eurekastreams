...
/**
 * Creates a 2 column layout with a right column of 66%.
 */
public class TwoColumnRightWideLayoutStrategy implements LayoutPanelStrategy
{
    /**
     * List of drop zones.
     */
     ...
     * Public constructor.
     */
    public TwoColumnRightWideLayoutStrategy()
    {
        dropZones.add(DropZonePanel.getThirdColumnDropZone(0));
        dropZones.add(DropZonePanel.getTwoThirdColumnDropZone(1));
    }
