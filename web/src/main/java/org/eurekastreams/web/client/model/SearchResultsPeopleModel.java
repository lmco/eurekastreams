 ...
 *
 */
public class SearchResultsPeopleModel extends BaseModel implements Fetchable<GetDirectorySearchResultsRequest>
{
    /**
     * Singleton.
     */
    private static SearchResultsPeopleModel model = new SearchResultsPeopleModel();
     ...
     */
    public static SearchResultsPeopleModel getInstance()
    {
        return model;
    }
    ...
    {
        super.callReadAction("getDirectorySearchResultsPeople", request, new OnSuccessCommand<PagedSet>()
        {
