 ...
 */
public class StreamPanel2 extends FlowPanel implements Bindable
{
    /**
     * What am I doing?
     * 
     ...
     *            title of stream.
     */
    public StreamPanel2(final ActionProcessor inProcessor, final StreamView inView, final boolean inCanPost,
