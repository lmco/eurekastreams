 ...
 *
 */
public class SearchResultsOrgModel extends BaseModel implements Fetchable<GetDirectorySearchResultsRequest>
{
    /**
     * Singleton.
     */
    private static SearchResultsOrgModel model = new SearchResultsOrgModel();
     ...
     */
    public static SearchResultsOrgModel getInstance()
    {
        return model;
    }
    ...
    {
        super.callReadAction("getDirectorySearchResultsOrgs", request, new OnSuccessCommand<PagedSet>()
        {
