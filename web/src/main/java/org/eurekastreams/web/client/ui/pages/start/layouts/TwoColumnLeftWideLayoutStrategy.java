...
/**
 * Creates a 2 column layout with a left column of 66%.
 */
public class TwoColumnLeftWideLayoutStrategy implements LayoutPanelStrategy
{
    /**
     * List of drop zones.
     */
     ...
     * Public constructor.
     */
    public TwoColumnLeftWideLayoutStrategy()
    {
        dropZones.add(DropZonePanel.getTwoThirdColumnDropZone(0));
