...
public final class GadgetCategorySelectedEvent
{
     ...
     * @return the event.
     */
    public static GadgetCategorySelectedEvent getEvent()
    {
        return new GadgetCategorySelectedEvent(null);
    }

    /**
     * @param inCategory the category that was selected
     */
    public GadgetCategorySelectedEvent(final String inCategory)
    {
        category = inCategory;
    }
