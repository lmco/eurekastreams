...
/**
 * 
 * PersonStreamPluginSubscriptionModel.
 *
 */
public class PersonStreamPluginSubscriptionModel  extends BaseModel implements
	Fetchable<String>, 
	...
	Updateable<HashMap<String, Serializable>>
{
     ...
     * Singleton.
     */
    private static PersonStreamPluginSubscriptionModel model = 
    	new PersonStreamPluginSubscriptionModel();
     ...
     */
    public static PersonStreamPluginSubscriptionModel getInstance()
    {
        return model;
    }
    ...
    {
        super.callReadAction("getPluginsAndSubscriptionsForUser", request, 
        		new OnSuccessCommand<PluginAndFeedSubscriptionsResponse>()
        {
            public void onSuccess(final PluginAndFeedSubscriptionsResponse response)
            {
                Session.getInstance().getEventBus().notifyObservers(
                		new GotStreamPluginSubscriptionsResponseEvent(response));
            }
    ...
    {
        super.callWriteAction("persistPluginForUser", request, new OnSuccessCommand<Boolean>()
        {
            public void onSuccess(final Boolean response)
            {
                Session.getInstance().getEventBus().notifyObservers(
                		new InsertedStreamPluginSubscriptionResponseEvent(response));
            }
        });
    }
    ...
    {
        super.callWriteAction("deletePluginForUser", request, new OnSuccessCommand<Boolean>()
        {
            public void onSuccess(final Boolean response)
            {
                Session.getInstance().getEventBus().notifyObservers(
                		new DeletedStreamPluginSubscriptionResponseEvent(response));
            }
        });
    }
