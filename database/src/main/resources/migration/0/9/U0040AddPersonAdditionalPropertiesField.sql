insert into db_version (major, minor, patch, scriptname, description) values (0, 9, '0040', 'U0040AddPersonAdditionalPropertiesField.sql', 'Adds column to the person table.');
