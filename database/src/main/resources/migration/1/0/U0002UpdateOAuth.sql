...
insert into oauthconsumer (version, callbackurl, consumerkey, consumersecret, gadgeturl, serviceprovidername, signaturemethod, title)
                   values (0, 'http://localhost/gadgets/oauthcallback', '38b78531332ea268', '9aa1b244cc61da7abaf287c70dfc', 'http://localhost/org/eurekastreams/gadgets/threeleggedoauthdemo.xml', 'sevengoslings', 'HMAC-SHA1', 'seven goslings 3-legged');
                   
insert into oauthconsumer (version, callbackurl, consumerkey, consumersecret, gadgeturl, serviceprovidername, signaturemethod, title)
                   values (0, null, '8c75c97c1ee51315', '6fd5e3f41a8b91b9cfdb80b59e5c', 'http://localhost/org/eurekastreams/gadgets/twoleggedoauthdemo.xml', 'shindig', 'HMAC-SHA1', 'seven goslings 2-legged');