...
/**
 * Test fixture for OrganizationToNameBridge.
 */
public class OrganizationToNameFieldBridgeTest
{
    /**
     * System under test.
     */
    private OrganizationToNameFieldBridge sut = new OrganizationToNameFieldBridge();
    ...
    {
        String name = "Looking for Spaceships";
        Organization o = new Organization(name, "greenones");
        assertEquals(name, sut.objectToString(o));
    }
