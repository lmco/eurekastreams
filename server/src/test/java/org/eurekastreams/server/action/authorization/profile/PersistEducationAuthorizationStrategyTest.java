 ...
 *
 */
public class PersistEducationAuthorizationStrategyTest extends MapperTest
{
    /**
     ...
     * subject under test.
     */
    PersistEducationAuthorizationStrategy sut;
    ...
    public void setup()
    {
        ...
        sut = new PersistEducationAuthorizationStrategy(enrollmentFindMapper);
