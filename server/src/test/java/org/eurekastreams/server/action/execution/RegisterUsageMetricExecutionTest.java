...
public class RegisterUsageMetricExecutionTest
{
     ...
     */
    private final DomainMapper<String, Long> personStreamScopeIdMapper = context.mock(DomainMapper.class,
            "personStreamScopeIdMapper");

    /**
     * Mapper to get a group stream scope id.
     */
    private final DomainMapper<String, Long> groupStreamScopeIdMapper = context.mock(DomainMapper.class,
     ...
     * System under test.
     */
    private final RegisterUsageMetricExecution sut = new RegisterUsageMetricExecution(personStreamScopeIdMapper,
    ...
    public final void textPerformActionForGroupStreamView() throws Exception
    {
        ...
        assertEquals(groupStreamScopeId,
                ((UsageMetric) (((PersistenceRequest) uar.get(0).getParams())).getDomainEnity())
    ...
    public final void textPerformActionForPersonStreamView() throws Exception
    {
        ...
        // make sure the stream scope id of the group was found
        assertEquals(presonStreamScopeId,
                ((UsageMetric) (((PersistenceRequest) uar.get(0).getParams())).getDomainEnity())
                        .getStreamViewStreamScopeId());
