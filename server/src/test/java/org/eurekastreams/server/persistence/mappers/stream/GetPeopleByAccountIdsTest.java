 ...
 */
public class GetPeopleByAccountIdsTest extends CachedMapperTest
{
    /**
     ...
     */
    private static final String PERSON_ID2 = "mrburns";

    /**
     * System under test.
     */
    @Autowired
    private GetPeopleByAccountIds mapper;
    ...
    public void testExecute()
    {
        ...
        assertTrue(results.get(0).getOptOutVideos().contains(6L));
    }
