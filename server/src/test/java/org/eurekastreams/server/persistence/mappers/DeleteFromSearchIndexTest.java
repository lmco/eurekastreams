...
/**
 * Test for DeleteFromSearchIndex class.
 * 
 */
public class DeleteFromSearchIndexTest
{
    /**
     * Helper class to mock out singleton-wrapping method.
     */
    private class DeleteFromSearchIndexTester extends DeleteFromSearchIndex
    {
        /**
    ...
    {
        DeleteFromSearchIndexRequest request = new DeleteFromSearchIndexRequest(String.class, 1L);
        DeleteFromSearchIndexTester sut = new DeleteFromSearchIndexTester();
        sut.setFullTextSession(fullTextSessionMock);

        context.checking(new Expectations()
        {
            {
                oneOf(fullTextSessionMock).purge(String.class, 1L);
            }
        });
