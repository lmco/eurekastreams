...
/**
 * Test fixture for FindSystemSettingsCacheDomainMapperImpl.
 */
public class FindSystemSettingsCacheDomainMapperImplTest
{
    /**
     * Test execute().
     */
    ...
    public void testExecute()
    {
        ...
        // perform system under test & make sure the settings were stored in cache
        assertSame(settings, sut.execute(null));
    }
}
