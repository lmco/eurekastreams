...
public class GetPendingDomainGroupsForOrgTest extends MapperTest
{
     ...
     */
    private OrganizationHierarchyCache organizationHierarchyCacheMock;
    ...
    public void setup()
    {
        organizationHierarchyCacheMock = context.mock(OrganizationHierarchyCache.class);

        sut = new GetPendingDomainGroupsForOrg(organizationHierarchyCacheMock);
    ...
    public void testExecute()
    {
        ...
        {
            {
                ...
                oneOf(requestMock).getOrgShortName();
                ...
                // make sure the sut is using the cache properly
                oneOf(organizationHierarchyCacheMock).getOrganizationIdFromShortName(shortName);
                will(returnValue(mainOrgId));
        ...
        assertEquals(8L, results.getPagedSet().get(1).getEntityId());
        ...
        assertEquals(saganDisplayName, results.getPagedSet().get(1).getPersonCreatedByDisplayName());
        ...
        assertEquals(saganAccountId, results.getPagedSet().get(1).getPersonCreatedByAccountId());
    }
}
