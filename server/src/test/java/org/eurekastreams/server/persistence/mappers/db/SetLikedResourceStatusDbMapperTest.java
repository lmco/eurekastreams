...
import org.eurekastreams.server.persistence.mappers.requests.SetLikedResourceStatusRequest;
import org.junit.Before;
import org.junit.Test;

/**
 * Test fixture for SetLikedResourceStatusDbMapper.
 */
public class SetLikedResourceStatusDbMapperTest extends MapperTest
{
    /**
     * System under test.
     */
    private SetLikedResourceStatusDbMapper sut;
    ...
    public void setup()
    {
        sut = new SetLikedResourceStatusDbMapper();
    ...
    public void testUnlikeWhenLiked()
    {
        ...
        sut.execute(new SetLikedResourceStatusRequest(personId, followedLink, BaseObjectType.BOOKMARK, false));
    ...
    public void testUnlikeWhenNotLiked()
    {
        ...
        sut.execute(new SetLikedResourceStatusRequest(personId, unfollowedLink, BaseObjectType.BOOKMARK, false));
    ...
    public void testLikeWhenLiked()
    {
        ...
        sut.execute(new SetLikedResourceStatusRequest(personId, followedLink, BaseObjectType.BOOKMARK, true));
    ...
    public void testLikingResourceThatDoesntExist()
    {
        ...
        sut.execute(new SetLikedResourceStatusRequest(personId, linkThatDoesntExist, BaseObjectType.BOOKMARK, true));
    ...
    public void testUnlikingResourceThatDoesntExist()
    {
        ...
        sut.execute(new SetLikedResourceStatusRequest(personId, linkThatDoesntExist, BaseObjectType.BOOKMARK, false));
