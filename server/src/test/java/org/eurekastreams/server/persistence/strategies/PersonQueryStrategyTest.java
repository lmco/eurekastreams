...
/**
 * Test for person query strategy.
 */
public class PersonQueryStrategyTest
{
    /**
     * Mocking context.
     */
     ...
     * System under test.
     */
    private PersonQueryStrategy sut;
    ...
    public void testGetCriteria()
    {
        ...
        {
            {
                oneOf(hibernateSession).createCriteria(Person.class);
            }
        });
