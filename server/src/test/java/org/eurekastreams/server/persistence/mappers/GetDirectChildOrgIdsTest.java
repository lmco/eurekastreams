...
/**
 * Test fixture for GetDirectChildOrgIdsTest.
 */
public class GetDirectChildOrgIdsTest extends CachedMapperTest
{
    /**
     * System under test.
     */
    private GetDirectChildOrgIds sut;
    ...
    /**
     * Test executes stores in cache by checking that subsequent calls get the same data.
     */
    @Test
    public void testExecuteStoresInCache()
    {
        ...
        assertSame(getCache().get(CacheKeys.ORGANIZATION_DIRECT_CHILDREN + 5L), results);
    }
    ...
    public void testExecuteWithWarmedCache()
    {
        ...
        childOrgIds.add(4L);
        childOrgIds.add(9L);
        getCache().set(CacheKeys.ORGANIZATION_DIRECT_CHILDREN + 5L, childOrgIds);
