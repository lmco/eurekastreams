...
/**
 * Test for GetChildOrgIdsRecursiveByOrgIdDbMapper.
 * 
 */
public class GetChildOrgIdsRecursiveByOrgIdDbMapperTest extends MapperTest
{
    /**
     * System under test.
     */
    @Autowired
    private GetChildOrgIdsRecursiveByOrgIdDbMapper sut;
    ...
    {
        List<Long> childOrgIds = sut.execute(otb.getOrg6a().getId());
    ...
    /**
     * Test execute. - leaf node.
     */
    @Test
    public void testExecute4()
    {
        List<Long> childOrgIds = sut.execute(otb.getOrg6a1().getId());
