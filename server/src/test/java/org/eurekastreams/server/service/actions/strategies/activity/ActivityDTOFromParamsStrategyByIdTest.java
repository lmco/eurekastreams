...
/**
 * Test for ActivityDTOFromParamsStrategyById.
 *
 */
public class ActivityDTOFromParamsStrategyByIdTest
{
    ...
    {
        Long activityId = new Long(5L);
        ActivityDTOFromParamsStrategyById sut = new ActivityDTOFromParamsStrategyById(activitiesDAO);
