...
public class PagedLdapSearchStrategyTest
{
    ...
    /**
     * Test the sut with specifying the page size.
     * This test is a duplicate of the previous test, just using the separate constructor.  This test doesn't
     * verify that the paging works because it would need to mock out the ldap searcher, which requires additional
     * effort than can be covered in this defect.  Leaving a todo for expanding this test.
     *
