...
/**
 * Test for OrganizationPersonLoaderCoordinators class.
 * 
 */
public class OrganizationPersonLoaderCoordinatorsTest
{
    /**
     ...
     * System under test.
     */
    private OrganizationPersonLoaderCoordinators sut;

    /**
     * Org cooridinator mapper mock.
     */
    private GetOrgCoordinators getOrgCoordinators = context.mock(GetOrgCoordinators.class);
    ...
    public void setUp()
    {
        sut = new OrganizationPersonLoaderCoordinators(getOrgCoordinators, getPeopleByIds);
    }
        ...
        {
            {
                ...
                allowing(getOrgCoordinators).execute(1L);
    ...
    public void testSetPeopleInOrganization()
    {
        ...
        {
            {
                allowing(organization).setCoordinators(results);
            }
        });
