...
/**
 * Test for AuthorizationException.
 * 
 */
public class AuthorizationExceptionTest
{
    ...
    {
        AuthorizationException sut = new AuthorizationException();
    ...
    {
        AuthorizationException sut = new AuthorizationException("msg");
    ...
    public void testConstructorWithThrowable()
    {
        ...
        AuthorizationException sut = new AuthorizationException(cause);
    ...
    {
        RuntimeException cause = new RuntimeException("cause");
        AuthorizationException sut = new AuthorizationException("msg", cause);
        assertEquals("msg", sut.getMessage());
        assertEquals(cause, sut.getCause());
    }
}
