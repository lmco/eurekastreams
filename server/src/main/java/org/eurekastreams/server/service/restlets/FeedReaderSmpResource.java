 ...
 */
public abstract class FeedReaderSmpResource extends Resource
{
    /**
     * Response adapter to make Responses from Restlet testable.
     */
    private Response adaptedResponse = null;

    /**
     * Default constructor.
     */
    protected FeedReaderSmpResource()
    {
        super();
     ...
     */
    protected Response getAdaptedResponse()
    {
     ...
     * 
     * @param inResponse
     *            - instance of Response to use for responses.
     */
    protected void setAdaptedResponse(final Response inResponse)
    {
