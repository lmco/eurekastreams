 ...
 * in Ldap environments configured to allow paging. If paging is not supported in the target ldap environment,
 * configure the DefaultLdapSearchStrategy which does not use paging.
 *
