 ...
 */
@Entity
@org.hibernate.annotations.Table(appliesTo = "UsageMetric", //
indexes = {
//
        @Index(name = "usagemetric_created_isstreamview_streamviewstreamscopeid_idx", columnNames = { "created",
                "streamViewStreamScopeId" }),

        // NOTE: ("created") and ("created", "isStreamView") are also used, so order is important
        @Index(name = "usagemetric_created_isstreamview_streamviewstreamscopeid_idx", //
        columnNames = { "created", "isStreamView", "streamViewStreamScopeId" }),

        @Index(name = "usagemetric_created_ispageview_idx", //
        columnNames = { "created", "ispageview" })

})
public class UsageMetric implements Serializable, DomainEntityIdentifiable
{
    /**
     * Serial version UID.
     */
