...
public class ActivityTemplateEmailBuilder implements NotificationEmailBuilder
{
     ...
     */
    public ActivityTemplateEmailBuilder(final BulkActivitiesMapper inActivitiesMapper,
    ...
    public void build(final NotificationDTO inNotification, final MimeMessage inMessage) throws Exception
    {
        ...
        // retrieve activity
        ActivityDTO activity = activitiesMapper.execute(inNotification.getActivityId(), null);
        if (activity == null)
        {
