...
public class NotificationBatch
{
    ...
    private final PropertyMap<Object> properties = new PropertyHashMap<Object>();
     ...
     */
    public PropertyMap<Object> getProperties()
    {
        return properties;
    }
    ...
    {
        properties.put(key, type, identity);
    }

    /**
     * Convenience method to cause two keys to point to the same property.
     * 
     * @param aliasKey
     *            New key.
     * @param originalKey
     *            Existing key.
     */
    public void setPropertyAlias(final String aliasKey, final String originalKey)
    {
        properties.putAlias(aliasKey, originalKey);
    }
}
