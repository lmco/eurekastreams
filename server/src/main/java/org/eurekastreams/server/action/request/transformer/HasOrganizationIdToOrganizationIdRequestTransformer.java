 ...
 */
public class HasOrganizationIdToOrganizationIdRequestTransformer implements RequestTransformer
{
    /**
     * Extracts the org id from the request.
     *
    ...
    public Serializable transform(final ActionContext inActionContext)
    {
        ...
        return Long.toString(((HasOrganizationId) inActionContext.getParams()).getOrganizationId());
    }
