...
public class EmailAddressValidator
{
     ...
     * @param inInValidEmailError invalid email error message.
     */
    public EmailAddressValidator(final String inValidEmailRegex, final String inInValidEmailError)
    {
        validEmailRegex = inValidEmailRegex;
        inValidEmailError = inInValidEmailError;
    }
    /**
     * @param emailAddress
     *            email to test.
