...
/**
 * Factory to build DomainGroupModelViews.
 */
public class DomainGroupModelViewFactory extends ModelViewFactory<DomainGroupModelView>
{
    /**
     * Build a new DomainGroupModelView.
     * 
