...
/**
 * This mapper returns the details of an existing in-app notification for a recipient and URL
 * if one exists.
 */
public class GetInAppNotificationByUserIdAndUrl extends
		BaseArgDomainMapper<InAppNotificationEntity, InAppNotificationEntity> 
{
	 ...
	 * 
	 * @param inRequest Container for search criteria. Callers should populate the recipient and url properties
