...
/**
 * Response object for GetStreamFiltersByUser DAO.
 *
 */
public class GetStreamFiltersByUserResponse
{
    /**
    ...
    /**
     * Hidden line index for user's stream views.
     */
     ...
     * @param inStreamFilters List of user's {@link StreamFilter}s
     */
    public GetStreamFiltersByUserResponse(final Integer inHiddenLineIndex, final List<StreamFilter> inStreamFilters)
    {
