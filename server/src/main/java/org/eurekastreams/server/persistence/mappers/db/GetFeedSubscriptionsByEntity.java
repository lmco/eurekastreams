...
/**
 * Get me all the feed subs for an entity.
 *
 */
public class GetFeedSubscriptionsByEntity extends ReadMapper<GetFeedSubscriberRequest, List<FeedSubscriber>>
{
    /**
     * Execute.
    ...
    @Override
    public List<FeedSubscriber> execute(final GetFeedSubscriberRequest inRequest)
    {
        String query = "FROM FeedSubscriber WHERE entityId=:entityId AND type = :type";
