 ...
 */
public class GetUserIdsWithUnreadInAppNotificationsByDate extends BaseArgDomainMapper<Date, List<Long>>
{
    /**
    ...
    {
        String q = "select distinct recipient.id from InAppNotification "
