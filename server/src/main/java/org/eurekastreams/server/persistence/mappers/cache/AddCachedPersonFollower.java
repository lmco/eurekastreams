...
public class AddCachedPersonFollower extends CachedDomainMapper
{
     ...
     */
    private final GetFollowedPersonIds followedMapper;
     ...
     * @param inFollowedMapper = mapper to retrieve the list of users that the
     * current user is following.
     * @param inFollowerMapper - mapper to retrieve the list of users that are
     * following the new target user.
     */
    public AddCachedPersonFollower(final GetFollowedPersonIds inFollowedMapper,
     ...
     * @param followingId - target user of the relationship, the new user being followed.
