...
public class ActivityDeletePropertyStrategy
{
     ...
     */
    public ActivityDeletePropertyStrategy(final GetPeopleByAccountIds inPersonByAccountIdDAO,
    ...
    /**
     * Sets Deletable property on activity for a given
     * activity and user.
     * @param inUserAccountId The current user's account id.
     * @param inActivity The activity.
     */
    public void execute(final String inUserAccountId, final ActivityDTO inActivity)
    {
        ...
        if (inActivity.getDestinationStream().getType() == EntityType.GROUP
                && isCurrentUserGroupCoordinator(
                        getUserPersonIdByAccountId(inUserAccountId), 
     ...
     */
    private boolean isCurrentUserGroupCoordinator(final Long inUserPersonId,
            final String inGroupShortName)
    {
        ...
        return groupCoordinatorIdsDAO.hasGroupCoordinatorAccessRecursively(
