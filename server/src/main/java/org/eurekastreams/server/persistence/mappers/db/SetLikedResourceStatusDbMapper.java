 ...
 */
public class SetLikedResourceStatusDbMapper extends BaseArgDomainMapper<SetLikedResourceStatusRequest, Boolean>
{
    /**
     * Logger.
     */
    ...
    public Boolean execute(final SetLikedResourceStatusRequest inRequest)
    {
