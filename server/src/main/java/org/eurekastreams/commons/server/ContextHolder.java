...
/**
 * Holds the ServletContext. This class is used to work around a problem we were
 * having making sure Spring injected the ServletContext into various pieces
 * that needed it -- sometimes the injection was called, sometimes not. This
 * thing always gets the context. Add it as a constructor parameter to Spring
 * beans that need the context.
 */
public class ContextHolder implements ServletContextAware
{
     ...
     * Logger.
     */
    private Log log = LogFactory.getLog(ContextHolder.class);
