 ...
 */
public class TaskHandlerActionContextImpl<T extends ActionContext> implements TaskHandlerActionContext<T>
{
    /**
     ...
     */
    private final List<UserActionRequest> userActionRequests;
     ...
     */
    public TaskHandlerActionContextImpl(final T inActionContext, final List<UserActionRequest> inUserActionRequests)
    {
